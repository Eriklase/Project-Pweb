...
<div class="mb-4">
    ...
    <h2 class="fw-bold">Tambah Mahasiswa Baru</h2>
    <p class="text-muted">Lengkapi formulir di bawah untuk mendaftarkan mahasiswa baru.</p>
</div>
                ...
                <form action="{{ route('admin.mahasiswa.store') }}" method="POST">
                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="nim" class="form-control @error('nim') is-invalid @enderror" value="{{ old('nim') }}" required placeholder="Contoh: 2021001001">
                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" name="semester" class="form-control @error('semester') is-invalid @enderror" value="{{ old('semester', 1) }}" required min="1" max="14">
